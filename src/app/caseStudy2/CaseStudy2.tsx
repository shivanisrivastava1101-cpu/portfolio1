...
import svgPathsNew from "../../imports/svg-j9uz8f8dd5";
import navSvgPaths from "../../imports/svg-erpmt3msaq";
import { ImageWithFallback } from "./figma/ImageWithFallback";
import storyMapImage from "figma:asset/8a8c55f06eb29484622695112cea3758f0702ad0.png";
import newStoryMapImage from "figma:asset/fd9dbf33c3e88f10df47b4166eadbc91a30f77a1.png";
import latestStoryMapImage from "figma:asset/f1f9f4e2b85e7efe55d4a5cd18a1e4f7e8a4bda1.png";
import finalStoryMapImage from "figma:asset/6eaa6e76eda62e24b1d8d0ba5b9a84fb89a99a6f.png";
...
function Header() {
  return (
    <div className="bg-[#1a1a1a] border-b border-[#1d293d] border-solid w-full py-[12px] px-[24px] flex items-center justify-between fixed top-0 left-0 right-0 z-50">
      <a href="https://www.figma.com/make/ryjMj7979jPu5bQzQlWm28/Personal?fullscreen=1&t=fB0A2cqWhsXvMeyB-1" target="_blank" rel="noopener noreferrer" className="font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic text-white text-[14px] hover:text-[#93c5fd] transition-colors cursor-pointer">Product & UX Designer</a>
      <div className="flex gap-[32px]">
        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[24px] not-italic text-[#d1d5dc] text-[16px] text-center cursor-pointer hover:text-white transition-colors">Work</p>
        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[24px] not-italic text-[#d1d5dc] text-[16px] text-center cursor-pointer hover:text-white transition-colors">About</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="relative shrink-0 size-[20px]">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g>
          <path d={navSvgPaths.p3713e00} stroke={strokeColor} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          <path d={navSvgPaths.pd2076c0} stroke={strokeColor} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          <path d="M8.33333 7.5H6.66667" stroke={strokeColor} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          <path d="M13.3333 10.8333H6.66667" stroke={strokeColor} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          <path d="M13.3333 14.1667H6.66667" stroke={strokeColor} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
        </g>
      </svg>
    </div>
  );
    ...
    <div className="relative shrink-0 size-[20px]">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g clipPath="url(#clip0_2_277)">
          <path d={navSvgPaths.p14d24500} stroke={strokeColor} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          <path d="M10 6.66667V10" stroke={strokeColor} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          <path d="M10 13.3333H10.0083" stroke={strokeColor} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
        </g>
        <defs>
...
function RoleIcon({ isActive }: { isActive: boolean }) {
  ...
  return (
    <div className="relative shrink-0 size-[20px]">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g>
          <path d={navSvgPaths.pe6b10c0} stroke={strokeColor} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          <path d={navSvgPaths.p4c21d00} stroke={strokeColor} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
        </g>
      </svg>
    </div>
  );
...
function ApproachIcon({ isActive }: { isActive: boolean }) {
  ...
  return (
    <div className="relative shrink-0 size-[20px]">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g>
          <path d={navSvgPaths.p3c797180} stroke={strokeColor} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          <path d={navSvgPaths.p3ac0b600} stroke={strokeColor} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
        </g>
      </svg>
    </div>
  );
...
function ImpactIcon({ isActive }: { isActive: boolean }) {
  ...
  return (
    <div className="relative shrink-0 size-[20px]">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g>
          <path d={navSvgPaths.p2566d000} stroke={strokeColor} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          <path d={navSvgPaths.p1bf79e00} stroke={strokeColor} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
        </g>
      </svg>
    </div>
  );
...
function InitialDesignIcon({ isActive }: { isActive: boolean }) {
  ...
  return (
    <div className="relative shrink-0 size-[20px]">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g>
          <path d="M11.6667 1.66667H5C4.55797 1.66667 4.13405 1.84226 3.82149 2.15482C3.50893 2.46738 3.33334 2.89131 3.33334 3.33334V16.6667C3.33334 17.1087 3.50893 17.5326 3.82149 17.8452C4.13405 18.1577 4.55797 18.3333 5 18.3333H15C15.442 18.3333 15.866 18.1577 16.1785 17.8452C16.4911 17.5326 16.6667 17.1087 16.6667 16.6667V6.66667L11.6667 1.66667Z" stroke={strokeColor} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          <path d="M11.6667 1.66667V6.66667H16.6667" stroke={strokeColor} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          <path d="M13.3333 10.8333H6.66667" stroke={strokeColor} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          <path d="M13.3333 14.1667H6.66667" stroke={strokeColor} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          <path d="M8.33333 7.5H7.5H6.66667" stroke={strokeColor} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
        </g>
      </svg>
    </div>
  );
...
function WhyFailedIcon({ isActive }: { isActive: boolean }) {
  ...
  return (
    <div className="relative shrink-0 size-[20px]">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g>
          <path d="M10 18.3333C14.6024 18.3333 18.3333 14.6024 18.3333 10C18.3333 5.39763 14.6024 1.66667 10 1.66667C5.39763 1.66667 1.66667 5.39763 1.66667 10C1.66667 14.6024 5.39763 18.3333 10 18.3333Z" stroke={strokeColor} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          <path d="M12.5 7.5L7.5 12.5" stroke={strokeColor} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          <path d="M7.5 7.5L12.5 12.5" stroke={strokeColor} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
        </g>
      </svg>
    </div>
  );
...
function DesignSolutionIcon({ isActive }: { isActive: boolean }) {
  ...
  return (
    <div className="relative shrink-0 size-[20px]">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g>
          <path d="M10 1.66667V4.16667" stroke={strokeColor} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          <path d="M10 15.8333V18.3333" stroke={strokeColor} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          <path d="M3.51666 3.51667L5.34166 5.34167" stroke={strokeColor} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          <path d="M14.6583 14.6583L16.4833 16.4833" stroke={strokeColor} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          <path d="M1.66666 10H4.16666" stroke={strokeColor} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          <path d="M15.8333 10H18.3333" stroke={strokeColor} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          <path d="M3.51666 16.4833L5.34166 14.6583" stroke={strokeColor} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          <path d="M14.6583 5.34167L16.4833 3.51667" stroke={strokeColor} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
          <path d="M10 13.3333C11.841 13.3333 13.3333 11.841 13.3333 10C13.3333 8.15905 11.841 6.66667 10 6.66667C8.15905 6.66667 6.66667 8.15905 6.66667 10C6.66667 11.841 8.15905 13.3333 10 13.3333Z" stroke={strokeColor} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
        </g>
      </svg>
    </div>
  );
...
function WhyWorksIcon({ isActive }: { isActive: boolean }) {
  ...
  return (
    <div className="relative shrink-0 size-[20px]">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g>
          <path d="M16.6667 5L7.50001 14.1667L3.33334 10" stroke={strokeColor} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
        </g>
      </svg>
    </div>
  );
...
function TopNavigation({ activeSection, setActiveSection, isScrollingRef }: { activeSection: string; setActiveSection: (section: string) => void; isScrollingRef: React.MutableRefObject<boolean> }) {
  ...
  const sections = [
    ...
    { id: "design-solution", label: "Design Solution", Icon: DesignSolutionIcon },
  ...
  return (
    ...
    >
      <div className="bg-white w-full content-stretch flex items-center md:justify-center px-[24px] py-[16px] relative z-50 border-b border-[#e2e8f0] border-solid min-w-max md:min-w-0">
        ...
        <div className="flex flex-row gap-[8px] items-center relative">{sections.map((section, index) => {
            ...
            return (
              <div key={section.id} className="flex items-center gap-[8px]">
                <button
                  ...
                  onClick={(e) => {
                    ...
                    if (element) {
                      ...
                      const targetPosition = window.scrollY + elementRect.top - scrollOffset;
                ...
                >
                  {isActive && (
                    <div aria-hidden="true" className="absolute border-[#155dfc] border-b-2 border-solid inset-0 pointer-events-none" />
                  )}
                  <div className="content-stretch flex items-center relative size-full">
                    <p className={`font-['Inter:Medium',sans-serif] font-medium leading-[20px] text-[14px] whitespace-nowrap transition-all duration-300 ${
                      isActive 
                        ? 'text-[#1447e6]' 
                ...
                {index < sections.length - 1 && (
                  <div className="h-[2px] w-[32px] relative">
                    <div aria-hidden="true" className="absolute border-[#cad5e2] border-dashed border-t-2 inset-0 pointer-events-none" />
                  </div>
                )}
              </div>
            );
  ...
  return (
    <div className="flex items-center gap-[12px] flex-wrap">
      <div className="bg-gradient-to-r from-[#0468B1] to-[#0080D7] border border-[#0468B1] border-solid h-[38px] rounded-[33554400px] w-fit px-[16px] flex items-center shadow-lg shadow-blue-200">
        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic text-white text-[14px]">UX Designer (Feature Lead)</p>
      </div>
      <div className="bg-white border border-[#e2e8f0] border-solid h-[38px] rounded-[33554400px] w-fit px-[16px] flex items-center gap-[8px]">
        ...
        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic text-[#0468B1] text-[14px]">Tech for Good · UNDP Partner</p>
      </div>
    </div>
  );
}
...
function PageDescription() {
  return (
    <div className="w-full max-w-[800px]">
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[42px] not-italic text-[#475569] text-[26px]">Enabling non-technical communities to create map-based stories for global impact</p>
    </div>
  );
}
...
function InfoLabel({ text }: { text: string }) {
  return (
    <p className="font-['Inter:Medium',sans-serif] font-medium leading-[20px] not-italic text-[#62748e] text-[14px] tracking-[0.7px] uppercase">{text}</p>
  );
}

function InfoValue({ text }: { text: string }) {
  return (
    <p className="font-['Inter:Regular',sans-serif] font-normal leading-[24px] not-italic text-[#0f172b] text-[16px]">{text}</p>
  );
}

function InfoCard({ label, value, gridCol }: { label: string; value: string; gridCol: string }) {
  return (
  ...
  return (
    <div className="w-full bg-gradient-to-br from-[#f8fafc] to-[#f1f5f9] rounded-[20px] border border-[#e2e8f0] p-[40px] shadow-sm">
      <div className="gap-x-[48px] gap-y-[48px] grid grid-cols-[repeat(3,minmax(0,1fr))] w-full">
        <InfoCard label="Role" value="UX Designer (Feature Lead)" gridCol="col-1" />
        <InfoCard label="Timeline" value="1 month" gridCol="col-2" />
        <InfoCard label="Team" value="Hana Lee, Jose Buitron, Derek Caelin" gridCol="col-3" />
      </div>
    </div>
  );
}
...
function SectionHeading({ text }: { text: string }) {
  return (
    <div className="flex items-center gap-[16px] mb-[8px]">
      ...
      <h2 className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[44px] not-italic text-[#0f172b] text-[40px] tracking-[-0.01em]">{text}</h2>
    </div>
  );
}
      ...
      <div className="absolute inset-[8.33%]">
        <div className="absolute inset-[-5%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 22 22">
            <path d={svgPaths.pb60700} stroke="var(--stroke-0, #45556C)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
          </svg>
        </div>
      </div>
      <div className="absolute bottom-1/2 left-1/2 right-1/2 top-[33.33%]">
        <div className="absolute inset-[-25%_-1px]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 2 6">
            <path d="M1 1V5" stroke="var(--stroke-0, #45556C)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
          </svg>
        </div>
      </div>
      <div className="absolute bottom-[33.33%] left-1/2 right-[49.96%] top-[66.67%]">
        <div className="absolute inset-[-1px_0_-1px_-25%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 2 2">
            <path d="M1 1H1.01" stroke="var(--stroke-0, #45556C)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
          </svg>
        </div>
      </div>
    </div>
...
function ProblemIcon2() {
  return (
    <div className="h-[24px] overflow-clip relative shrink-0 w-full">
      <div className="absolute inset-[8.33%]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
          <path d="M10 18C14.4183 18 18 14.4183 18 10C18 5.58172 14.4183 2 10 2C5.58172 2 2 5.58172 2 10C2 14.4183 5.58172 18 10 18Z" stroke="var(--stroke-0, #45556C)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
          <path d="M10 6V10L13 11" stroke="var(--stroke-0, #45556C)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
        </svg>
      </div>
    </div>
  );
...
function ProblemIcon3() {
  return (
    <div className="h-[24px] overflow-clip relative shrink-0 w-full">
      <div className="absolute inset-[8.33%]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
          <path d="M2 5L10 13L18 5" stroke="var(--stroke-0, #45556C)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
        </svg>
      </div>
    </div>
  );
        ...
        <div className="flex-[1_0_0] min-h-px min-w-px relative">
          <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col gap-[8px] items-start relative size-full">
            <div className="h-[28px] relative shrink-0 w-full">
              <p className="font-['Inter:Medium',sans-serif] font-medium leading-[28px] not-italic text-[#0f172b] text-[18px]">{title}</p>
            </div>
            <div className="relative shrink-0 w-full">
              <p className="font-['Inter:Regular',sans-serif] font-normal leading-[26px] not-italic text-[#45556c] text-[16px]">{description}</p>
            </div>
          </div>
        </div>
      </div>
  ...
  return (
    <div className="content-stretch flex flex-col gap-[32px] items-start w-full">
      ...
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[26px] not-italic text-[#314158] text-[16px] max-w-[768px]">
        Communities working in sustainability and conservation rely on storytelling to share knowledge and mobilize support. While users deeply understand their landscapes, most lack the technical skills to create interactive story maps.
      </p>
      ...
      <div className="relative overflow-hidden bg-gradient-to-br from-[#dbeafe] via-[#e0f2fe] to-[#bfdbfe] rounded-[20px] border-2 border-[#0468B1] p-[36px] w-full shadow-xl shadow-blue-200/50 mt-[16px]">
        ...
        <div className="relative flex items-start gap-[20px]">
          ...
          <div>
            <h4 className="font-['Inter:Semi_Bold',sans-serif] font-semibold text-[#0f172b] text-[20px] mb-[12px]">Design Challenge</h4>
            <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[30px] text-[#1e3a8a] text-[18px]">
              Design a story creation experience that removes technical complexity while supporting real-world constraints — enabling communities to independently create and share map-based narratives.
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="relative z-10">
          ...
          <div className="flex flex-col items-center mb-[48px]">
            <div className="flex items-center gap-[12px] mb-[16px]">
              ...
              <span className="text-[#93c5fd] text-[14px] font-['Inter:Medium',sans-serif] font-medium uppercase tracking-[2px]">Testimonials</span>
              <div className="w-[40px] h-[2px] bg-gradient-to-l from-transparent via-[#3b82f6] to-[#3b82f6]"></div>
            </div>
            <h3 className="font-['Inter:Bold',sans-serif] font-bold text-[#ffffff] text-[32px] mb-[12px]">What Users Say</h3>
            <p className="font-['Inter:Regular',sans-serif] text-[#94a3b8] text-[16px] text-center max-w-[600px]">
              Real feedback from communities using Story Maps to share their narratives
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-[24px]">
            ...
            <div className="relative bg-gradient-to-br from-[#ffffff] via-[#fefefe] to-[#f8fafc] rounded-[16px] p-[36px] border border-[#e2e8f0] shadow-[0_8px_30px_rgb(0,0,0,0.12)] overflow-hidden group hover:shadow-[0_12px_40px_rgb(0,0,0,0.18)] hover:scale-[1.02] transition-all duration-300">
              ...
              <div className="absolute top-[16px] left-[16px] w-[48px] h-[48px] bg-gradient-to-br from-[#3b82f6] to-[#2563eb] rounded-full flex items-center justify-center shadow-lg opacity-90">
                <div className="text-white text-[24px] leading-[1] font-serif">"</div>
              </div>
              ...
              <div className="relative z-10 pt-[32px]">
                <p className="font-['Inter:Regular',sans-serif] font-normal leading-[28px] text-[#1e293b] text-[15px] mb-[28px]">
                  I went to Felt, I went to ArcGIS, they wanted so much money. I'm just a nonprofit trying to tell a story. But when I showed my team what I could do with Terraso for <span className="font-['Inter:Bold',sans-serif] font-bold text-[#2563eb] bg-[#dbeafe] px-[6px] py-[2px] rounded-[4px]">free</span>, they were so <span className="font-['Inter:Bold',sans-serif] font-bold text-[#2563eb] bg-[#dbeafe] px-[6px] py-[2px] rounded-[4px]">impressed</span>.
                </p>
            ...
            <div className="relative bg-gradient-to-br from-[#ffffff] via-[#fefefe] to-[#f8fafc] rounded-[16px] p-[36px] border border-[#e2e8f0] shadow-[0_8px_30px_rgb(0,0,0,0.12)] overflow-hidden group hover:shadow-[0_12px_40px_rgb(0,0,0,0.18)] hover:scale-[1.02] transition-all duration-300">
              ...
              <div className="relative z-10 pt-[32px]">
                <p className="font-['Inter:Regular',sans-serif] font-normal leading-[28px] text-[#1e293b] text-[15px] mb-[28px]">
                  By integrating mapping, data collection, and storytelling, I've been able to promote <span className="font-['Inter:Bold',sans-serif] font-bold text-[#16a34a] bg-[#dcfce7] px-[6px] py-[2px] rounded-[4px]">regenerative farming</span>, foster community ownership, and support data-driven decisions for resilience and sustainable impact.
                </p>
            ...
            <div className="relative bg-gradient-to-br from-[#ffffff] via-[#fefefe] to-[#f8fafc] rounded-[16px] p-[36px] border border-[#e2e8f0] shadow-[0_8px_30px_rgb(0,0,0,0.12)] overflow-hidden group hover:shadow-[0_12px_40px_rgb(0,0,0,0.18)] hover:scale-[1.02] transition-all duration-300">
              ...
              <div className="relative z-10 pt-[32px]">
                <p className="font-['Inter:Regular',sans-serif] font-normal leading-[28px] text-[#1e293b] text-[15px] mb-[28px]">
                  Story Maps is a <span className="font-['Inter:Bold',sans-serif] font-bold text-[#ea580c] bg-[#ffedd5] px-[6px] py-[2px] rounded-[4px]">turning point</span> in how we tell stories… offering something deeply <span className="font-['Inter:Bold',sans-serif] font-bold text-[#ea580c] bg-[#ffedd5] px-[6px] py-[2px] rounded-[4px]">transformational</span> for countries like mine.
                </p>
...
function ContextSection() {
  return (
    <div className="content-stretch flex flex-col gap-[32px] items-start w-full">
      <div className="flex items-center gap-[16px] mb-[8px]">
        <div className="w-[6px] h-[40px] bg-gradient-to-b from-[#0468B1] to-[#0080D7] rounded-full"></div>
        <h3 className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[44px] not-italic text-[#0f172b] text-[40px] tracking-[-0.01em]">Context</h3>
      </div>
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[28px] not-italic text-[#314158] text-[17px]">
        Terraso is a platform developed by Tech Matters to support agricultural and conservation communities in planning and financing sustainable futures. It provides tools for mapping, data collection, and collaboration across landscapes.
      </p>
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[28px] not-italic text-[#314158] text-[17px]">
        As part of this ecosystem, Story Maps was introduced to help communities share place-based narratives using maps, images, and video.
      </p>
      <div className="relative overflow-hidden bg-gradient-to-r from-[#dbeafe] to-[#bfdbfe] rounded-[16px] p-[28px] border-2 border-[#0468B1] shadow-lg">
        ...
        <div className="relative flex items-start gap-[16px]">
          ...
          <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[28px] text-[#1e3a8a] text-[18px]">
            My responsibility was to lead the UX design of the Story Map creation experience.
          </p>
        </div>
      </div>
    </div>
  ...
  return (
    <div className="relative overflow-hidden bg-gradient-to-br from-[#e0f2fe] via-[#f0f9ff] to-[#ecfdf5] w-full rounded-[20px] border-2 border-[#0468B1] border-solid shadow-[0px_8px_24px_0px_rgba(4,104,177,0.15)] p-[40px]">
      ...
      <div className="relative flex items-start gap-[20px]">
        ...
        <div>
          <h4 className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[32px] not-italic text-[#0f172b] text-[22px] mb-[12px]">The Result</h4>
          <p className="font-['Inter:Medium',sans-serif] font-medium leading-[28px] not-italic text-[#334155] text-[18px]">
            A streamlined creation tool that removes technical barriers while giving users full creative control over their map-based narratives.
          </p>
        </div>
      </div>
    </div>
...
function CheckIcon() {
  return (
    <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 15 14">
      <path d={svgPaths.p38669a00} stroke="var(--stroke-0, #193CB8)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" />
    </svg>
  );
}
...
function RoleBulletPoint({ text }: { text: string }) {
  return (
    <div className="flex gap-[12px] items-start w-full">
      ...
      <p className="flex-1 font-['Inter:Regular',sans-serif] font-normal leading-[26px] not-italic text-[#314158] text-[16px]">{text}</p>
    </div>
  );
}
...
function ImpactMetricCard({ 
  ...
  return (
    <div 
      ...
      style={gradient ? { backgroundImage: gradient } : { backgroundColor: 'white' }}
    >
      <div className={`${emojiColor} rounded-[10px] size-[48px] flex items-center justify-center mb-[32px]`}>
        <span className="text-[24px]">{emoji}</span>
      </div>
      {value && (
        <p className="font-['Inter:Bold',sans-serif] font-bold leading-[40px] not-italic text-[#0f172b] text-[36px] mb-[8px]">{value}</p>
      )}
      <h4 className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[28px] not-italic text-[#0f172b] text-[18px] mb-[8px]">{title}</h4>
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[22.75px] not-italic text-[#45556c] text-[14px]">{description}</p>
    </div>
  );
}
    ...
    <div className="bg-[#1a1a1a] border-t border-[#1d293d] border-solid w-full py-[49px] px-[173px]">
      <div className="flex flex-col gap-[16px] items-center justify-center w-full">
        <div className="flex flex-col gap-[4px] items-center">
          <p className="font-['Inter:Regular',sans-serif] font-normal leading-[24px] not-italic text-[#cad5e2] text-[16px] text-center px-[116px] py-[0px]">Designed with ❤️ by<br /> Shivani Srivastava</p>
        </div>
        <div className="flex gap-[8px] items-center">
          <div className="size-[20px]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
              <g>
                <path d={svgPaths.peba4c00} stroke="var(--stroke-0, #CAD5E2)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
                <path d="M5 7.5H1.66667V17.5H5V7.5Z" stroke="var(--stroke-0, #CAD5E2)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
                <path d={svgPaths.p25677470} stroke="var(--stroke-0, #CAD5E2)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
              </g>
            </svg>
          </div>
          <p className="font-['Inter:Regular',sans-serif] font-normal leading-[24px] not-italic text-[#cad5e2] text-[16px] text-center">LinkedIn</p>
        </div>
      </div>
    </div>
  );
...
function SolutionSection() {
  return (
    <div className="content-stretch flex flex-col gap-[32px] items-start w-full">
      ...
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[26px] not-italic text-[#314158] text-[16px] max-w-[768px]">
        We created an intuitive story creation experience that abstracts technical complexity while preserving the power of map-based storytelling.
      </p>
      ...
      <div className="w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-[24px]">
        ...
        <div className="group bg-white border-2 border-[#e2e8f0] rounded-[20px] p-[32px] shadow-lg hover:shadow-2xl hover:border-[#0468B1] transition-all duration-300 hover:-translate-y-1">
          ...
          <p className="font-['Inter:Regular',sans-serif] leading-[24px] text-[#64748b] text-[15px]">
            Drag-and-drop interface for creating chapters, adding media, and arranging narrative flow
          </p>
        </div>
        ...
        <div className="group bg-white border-2 border-[#e2e8f0] rounded-[20px] p-[32px] shadow-lg hover:shadow-2xl hover:border-[#059669] transition-all duration-300 hover:-translate-y-1">
          ...
          <p className="font-['Inter:Medium',sans-serif] font-medium leading-[26px] text-[#64748b] text-[16px]">
            Add locations manually or through media geotags — no coordinates required
          </p>
        </div>
        ...
        <div className="group bg-white border-2 border-[#e2e8f0] rounded-[20px] p-[32px] shadow-lg hover:shadow-2xl hover:border-[#f59e0b] transition-all duration-300 hover:-translate-y-1">
          ...
          <p className="font-['Inter:Medium',sans-serif] font-medium leading-[26px] text-[#64748b] text-[16px]">
            Stories go live instantly without requiring technical setup or developer support
          </p>
        </div>
      </div>
      ...
      <div className="relative overflow-hidden bg-gradient-to-br from-[#ecfdf5] via-[#d1fae5] to-[#a7f3d0] rounded-[20px] border-2 border-[#059669] p-[36px] w-full shadow-lg shadow-green-200/50 mt-[16px]">
        ...
        <div className="relative flex items-start gap-[20px]">
          ...
          <div>
            <h4 className="font-['Inter:Semi_Bold',sans-serif] font-semibold text-[#0f172b] text-[20px] mb-[12px]">Design Philosophy</h4>
            <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[30px] text-[#065f46] text-[18px]">
              The interface was designed to feel familiar — like creating a presentation — while seamlessly handling the technical complexity of spatial storytelling behind the scenes.
            </p>
          </div>
        </div>
      </div>
...
function ContentContainer() {
  ...
  return (
    <div className="w-full max-w-[1104px] mx-auto px-[24px] py-[128px] flex flex-col gap-[80px]">
      ...
      <div id="problem" className="relative flex flex-col gap-[32px] scroll-mt-[110px] bg-gradient-to-br from-[#f8fafc] via-[#f1f5f9] to-[#e2e8f0] py-[72px] -mx-[24px] px-[24px] rounded-[24px] overflow-hidden border border-[#cbd5e1]">
      ...
      <div id="users" className="flex flex-col gap-[40px] scroll-mt-[110px]">
        <div className="flex flex-col gap-[24px]">
          ...
          <p className="font-['Inter:Regular',sans-serif] font-normal leading-[26px] not-italic text-[#314158] text-[16px] max-w-[768px]">
            To keep the team aligned around real user needs, we developed two primary personas: Luis and Pia. These personas helped ground design decisions in everyday workflows, motivations, and constraints — ensuring we built for people, not assumptions.
          </p>
          <p className="font-['Inter:Regular',sans-serif] font-normal leading-[26px] not-italic text-[#314158] text-[16px] max-w-[768px]">
            They were shared across product and engineering to maintain a user-centered perspective throughout the project.
          </p>
        ...
        <div className="bg-[#f0f9ff] rounded-[14px] border-l-4 border-[#3b82f6] p-[32px]">
          <h3 className="font-['Inter:Semi_Bold',sans-serif] font-semibold text-[#0f172b] text-[22px] mb-[8px]">What we uncovered in the user research</h3>
          <p className="font-['Inter:Medium',sans-serif] font-medium text-[#475569] text-[15px] mb-[24px]">User Stories</p>
          
          {/* Key Research Findings */}
          <div className="bg-white rounded-[12px] p-[24px] mb-[24px] shadow-sm border border-[#bfdbfe]">
            <h4 className="font-['Inter:Semi_Bold',sans-serif] font-semibold text-[#0f172b] text-[17px] mb-[16px]">Key Challenges</h4>
            <div className="flex flex-col gap-[16px]">
              <div className="flex items-start gap-[12px]">
                ...
                <p className="font-['Inter:Regular',sans-serif] leading-[24px] text-[#314158] text-[15px]">
                  Users have <span className="font-['Inter:Semi_Bold',sans-serif] font-semibold">limited network connectivity</span> and are working with communities to document traditional stories. They need to <span className="font-['Inter:Semi_Bold',sans-serif] font-semibold">load content offline</span> and upload it later when internet access is available.
                </p>
              </div>
              ...
              <div className="flex items-start gap-[12px]">
                ...
                <p className="font-['Inter:Regular',sans-serif] leading-[24px] text-[#314158] text-[15px]">
                  Users want to <span className="font-['Inter:Semi_Bold',sans-serif] font-semibold">collect location data</span> but don't always have it at hand. They need <span className="font-['Inter:Semi_Bold',sans-serif] font-semibold">offline-friendly tools for media capture</span> and want to capture data directly on a phone, including sensitive data that remains stored only on the device.
                </p>
              </div>
              ...
              <div className="flex items-start gap-[12px]">
                ...
                <p className="font-['Inter:Regular',sans-serif] leading-[24px] text-[#314158] text-[15px]">
                  Users want to capture <span className="font-['Inter:Semi_Bold',sans-serif] font-semibold">geo-referenced videos and photos</span> but feel limited by their current equipment. They seek <span className="font-['Inter:Semi_Bold',sans-serif] font-semibold">higher-quality audio and images</span> than what their phone provides.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-gradient-to-br from-white to-[#f8fafc] rounded-[12px] p-[28px] border border-[#cbd5e1]">
            <h4 className="font-['Inter:Semi_Bold',sans-serif] font-semibold text-[#0f172b] text-[17px] mb-[20px]">As a Creator, I want to...</h4>
      ...
      <div id="approach" className="flex flex-col gap-[32px] scroll-mt-[110px]">
        ...
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[26px] not-italic text-[#314158] text-[16px] max-w-[768px]">
          Using insights from Luis and Pia, I translated user stories into assumptions, triggers, and workflow requirements. This helped define a simplified creation flow — focusing on how non-technical users could move from content to published story maps with minimal friction.
        </p>
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[26px] not-italic text-[#314158] text-[16px] max-w-[768px]">
          I began by mapping Luis's storytelling journey — from gathering content to sharing stories with donors. This clarified key steps such as uploading media, associating locations, structuring chapters, and publishing.
        </p>
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[26px] not-italic text-[#314158] text-[16px] max-w-[768px]">
          These flows informed both low- and high-fidelity wireframes, which were reviewed frequently with product and engineering to balance user needs with technical constraints.
        </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-[24px] mb-[16px]">
              <div className="bg-white rounded-[12px] shadow-lg overflow-hidden border border-[#e2e8f0] hover:shadow-xl transition-shadow">
                ...
                <div className="px-[16px] py-[12px] bg-[#f8fafc] border-t border-[#e2e8f0]">
                  <p className="font-['Inter:Medium',sans-serif] font-medium text-[#475569] text-[14px]">Dashboard</p>
                </div>
              </div>
              <div className="bg-white rounded-[12px] shadow-lg overflow-hidden border border-[#e2e8f0] hover:shadow-xl transition-shadow">
                <ImageWithFallback 
                ...
                />
                <div className="px-[16px] py-[12px] bg-[#f8fafc] border-t border-[#e2e8f0]">
                  <p className="font-['Inter:Medium',sans-serif] font-medium text-[#475569] text-[14px]">Edit Screen: Create Story Map</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <div id="initial-design" className="relative flex flex-col gap-[32px] scroll-mt-[110px] bg-gradient-to-br from-[#fef2f2] via-[#fef2f2] to-[#fee2e2] py-[72px] -mx-[24px] px-[24px] rounded-[24px] overflow-hidden border border-[#fecaca]">
        ...
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[26px] not-italic text-[#314158] text-[16px] max-w-[768px] mb-0">
          The first iteration reused Terraso's existing data map patterns to reduce development effort.
        </p>
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[26px] not-italic text-[#314158] text-[16px] max-w-[768px]">
          This approach offered clarity and faster implementation, but introduced experience trade-offs.
        </p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-[24px]">
          <div className="flex flex-col gap-[12px]">
            ...
            <p className="font-['Inter:Medium',sans-serif] text-[14px] text-[#64748b] text-center">Draft mode: Set Intro Page</p>
          </div>
          <div className="flex flex-col gap-[12px]">
            <div className="bg-white rounded-[12px] shadow-lg overflow-hidden border border-[#e2e8f0] hover:shadow-xl transition-shadow">
              <ImageWithFallback 
            ...
            <p className="font-['Inter:Medium',sans-serif] text-[14px] text-[#64748b] text-center">Draft mode: Setting Chapter 2 Page</p>
          </div>
          <div className="flex flex-col gap-[12px]">
            <div className="bg-white rounded-[12px] shadow-lg overflow-hidden border border-[#e2e8f0] hover:shadow-xl transition-shadow">
              <ImageWithFallback 
            ...
            <p className="font-['Inter:Medium',sans-serif] text-[14px] text-[#64748b] text-center">Draft mode: Set background map</p>
          </div>
        </div>
        ...
        <div className="bg-gradient-to-br from-[#f0fdf4] to-white rounded-[14px] border border-[#bbf7d0] p-[24px]">
          <div className="flex items-center gap-[10px] mb-[16px]">
            ...
            <h4 className="font-['Inter:Semi_Bold',sans-serif] font-semibold text-[#0f172b] text-[17px]">What worked</h4>
          </div>
          <ul className="flex flex-col gap-[10px]">
            <li className="font-['Inter:Regular',sans-serif] leading-[22px] text-[#314158] text-[14px] flex items-start gap-[10px]">
              <span className="text-[#22c55e] text-[16px] mt-[1px] font-bold">•</span>
              <span>Reused familiar Terraso layouts, reducing development overhead</span>
            </li>
            <li className="font-['Inter:Regular',sans-serif] leading-[22px] text-[#314158] text-[14px] flex items-start gap-[10px]">
              <span className="text-[#22c55e] text-[16px] mt-[1px] font-bold">•</span>
      ...
      <div id="why-failed" className="flex flex-col gap-[32px] scroll-mt-[110px]">
        <SectionHeading text="Why This Failed" />
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[26px] not-italic text-[#314158] text-[16px] max-w-[768px]">
          While technically efficient, the design created significant friction in the storytelling experience.
        </p>
        ...
        <div className="bg-gradient-to-br from-[#fef2f2] to-white rounded-[14px] border border-[#fecaca] p-[24px]">
          <div className="flex items-center gap-[10px] mb-[16px]">
            ...
            <h4 className="font-['Inter:Semi_Bold',sans-serif] font-semibold text-[#0f172b] text-[17px]">Key issues</h4>
          </div>
          <ul className="flex flex-col gap-[10px]">
            <li className="font-['Inter:Regular',sans-serif] leading-[22px] text-[#314158] text-[14px] flex items-start gap-[10px]">
              <span className="text-[#ef4444] text-[16px] mt-[1px] font-bold">×</span>
        ...
        <div className="bg-gradient-to-br from-[#fef3c7] to-[#fef9c3] rounded-[14px] border-l-4 border-[#f59e0b] p-[24px]">
          <p className="font-['Inter:Medium',sans-serif] font-medium leading-[26px] text-[#92400e] text-[16px]">
            This version surfaced an important insight: efficiency alone wasn't enough — narrative flow mattered.
          </p>
        </div>
      </div>
      
      {/* Section 4: Design Solution */}
      <div id="design-solution" className="relative flex flex-col gap-[32px] scroll-mt-[110px] bg-gradient-to-br from-[#ecfdf5] via-[#f0fdf4] to-[#dcfce7] py-[72px] -mx-[24px] px-[24px] rounded-[24px] overflow-hidden border border-[#86efac]">
        ...
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[26px] not-italic text-[#314158] text-[16px] max-w-[768px]">
          Based on usability feedback and stakeholder discussions, we decided to move away from a technically efficient layout toward a more narrative-driven experience.
        </p>
        ...
        <div className="bg-gradient-to-br from-[#eff6ff] to-[#dbeafe] rounded-[14px] border-l-4 border-[#3b82f6] p-[28px]">
          ...
          <p className="font-['Inter:Regular',sans-serif] leading-[26px] text-[#1e40af] text-[16px]">
            This led to a shift toward a chapter-based model inspired by familiar tools like PowerPoint and Google Slides, prioritising:
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-[16px]">
          <div className="bg-white rounded-[12px] p-[20px] border border-[#bfdbfe] shadow-sm">
            <div className="flex items-start gap-[12px]">
              ...
              <p className="font-['Inter:Regular',sans-serif] leading-[24px] text-[#314158] text-[15px]">Linear storytelling</p>
            </div>
          </div>
          <div className="bg-white rounded-[12px] p-[20px] border border-[#bfdbfe] shadow-sm">
            <div className="flex items-start gap-[12px]">
              <div className="bg-[#3b82f6] rounded-[6px] size-[6px] mt-[8px] shrink-0"></div>
              <p className="font-['Inter:Regular',sans-serif] leading-[24px] text-[#314158] text-[15px]">Clear chapter progression</p>
            </div>
          </div>
          <div className="bg-white rounded-[12px] p-[20px] border border-[#bfdbfe] shadow-sm">
            <div className="flex items-start gap-[12px]">
              <div className="bg-[#3b82f6] rounded-[6px] size-[6px] mt-[8px] shrink-0"></div>
              <p className="font-['Inter:Regular',sans-serif] leading-[24px] text-[#314158] text-[15px]">Embedded media</p>
            </div>
          </div>
          <div className="bg-white rounded-[12px] p-[20px] border border-[#bfdbfe] shadow-sm">
            <div className="flex items-start gap-[12px]">
              <div className="bg-[#3b82f6] rounded-[6px] size-[6px] mt-[8px] shrink-0"></div>
              <p className="font-['Inter:Regular',sans-serif] leading-[24px] text-[#314158] text-[15px]">Full-screen preview</p>
            </div>
          </div>
          <div className="bg-white rounded-[12px] p-[20px] border border-[#bfdbfe] shadow-sm md:col-span-2">
            <div className="flex items-start gap-[12px]">
              <div className="bg-[#3b82f6] rounded-[6px] size-[6px] mt-[8px] shrink-0"></div>
              <p className="font-['Inter:Regular',sans-serif] leading-[24px] text-[#314158] text-[15px]">Reduced navigation friction</p>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-[24px]">
          <div className="flex flex-col gap-[12px]">
            ...
            <p className="font-['Inter:Medium',sans-serif] text-[14px] text-[#64748b] text-center">Draft Mode: Add Chapters</p>
          </div>
          <div className="flex flex-col gap-[12px]">
            <div className="bg-white rounded-[12px] shadow-lg overflow-hidden border border-[#e2e8f0] hover:shadow-xl transition-shadow">
              <ImageWithFallback 
            ...
            <p className="font-['Inter:Medium',sans-serif] text-[14px] text-[#64748b] text-center">Draft Mode: Add Media to your chapters</p>
          </div>
          <div className="flex flex-col gap-[12px]">
            <div className="bg-white rounded-[12px] shadow-lg overflow-hidden border border-[#e2e8f0] hover:shadow-xl transition-shadow">
              <ImageWithFallback 
            ...
            <p className="font-['Inter:Medium',sans-serif] text-[14px] text-[#64748b] text-center">Preview Mode in Full Screen</p>
          </div>
          <div className="flex flex-col gap-[12px]">
            <div className="bg-white rounded-[12px] shadow-lg overflow-hidden border border-[#e2e8f0] hover:shadow-xl transition-shadow">
              <ImageWithFallback 
            ...
            <p className="font-['Inter:Medium',sans-serif] text-[14px] text-[#64748b] text-center">Share Story Map</p>
          </div>
        </div>
        
        <h3 className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[32px] not-italic text-[#0f172b] text-[24px] mt-[16px]">Final Experience</h3>
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[26px] not-italic text-[#314158] text-[16px] max-w-[768px]">
...
<div className="bg-gradient-to-r from-[#eff6ff] to-[#dbeafe] rounded-[14px] border-l-4 border-[#155DFC] p-[24px]">
          <p className="font-['Inter:Medium',sans-serif] font-medium leading-[26px] text-[#1e40af] text-[17px]">
            The experience was intentionally designed to feel like creating a slide deck, adapted for map-based storytelling.
          </p>
        </div>
        </div>
      </div>
      ...
      <div id="why-works" className="flex flex-col gap-[32px] scroll-mt-[110px]">
        <SectionHeading text="Why This Works" />
        <p className="font-['Inter:Regular',sans-serif] font-normal leading-[26px] not-italic text-[#314158] text-[16px] max-w-[768px]">
          This approach reduced cognitive load for non-technical users and supported real-world constraints such as low connectivity and field-based content creation.
        </p>
        <div className="bg-gradient-to-br from-[#f0f9ff] to-[#e0f2fe] rounded-[14px] border-l-4 border-[#0ea5e9] p-[28px]">
          <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[26px] text-[#0c4a6e] text-[17px]">
            More importantly, it allowed communities to focus on their stories — not the tooling.
          </p>
        </div>
      </div>
      ...
      <div id="outcome" className="flex flex-col gap-[56px] scroll-mt-[110px]">
        <div className="flex flex-col gap-[24px]">
          ...
          <p className="font-['Inter:Regular',sans-serif] font-normal leading-[28px] not-italic text-[#314158] text-[17px] max-w-[768px]">
            Story Maps enabled communities to independently create and publish map-based narratives, demonstrating global adoption and measurable impact across diverse use cases.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-[24px]">
          ...
          <div className="relative bg-gradient-to-br from-[#dbeafe] via-[#eff6ff] to-[#f8fafc] rounded-[20px] border-2 border-[#0468B1] p-[40px] shadow-xl shadow-blue-200/40 overflow-hidden group hover:shadow-2xl hover:shadow-blue-300/50 transition-all duration-300 hover:-translate-y-2">
            ...
            <div className="relative z-10 flex flex-col items-center text-center">
              <div className="bg-gradient-to-br from-[#0468B1] to-[#0080D7] rounded-full size-[64px] flex items-center justify-center mb-[20px] shadow-lg" role="img" aria-label="Authors icon">
                <Users className="text-white" size={32} strokeWidth={2} />
              </div>
              <div className="text-[56px] font-['Inter:Bold',sans-serif] font-bold bg-gradient-to-br from-[#0468B1] to-[#1e40af] bg-clip-text text-transparent mb-[12px] leading-[1]">100+</div>
              <div className="text-[17px] font-['Inter:Semi_Bold',sans-serif] font-semibold text-[#0f172b] mb-[10px]">Story Map Authors</div>
              <p className="text-[15px] font-['Inter:Medium',sans-serif] font-medium text-[#64748b] leading-[22px]">Actively creating and publishing map-based narratives</p>
            </div>
          </div>
          ...
          <div className="relative bg-gradient-to-br from-[#d1fae5] via-[#ecfdf5] to-[#f8fafc] rounded-[20px] border-2 border-[#059669] p-[40px] shadow-xl shadow-green-200/40 overflow-hidden group hover:shadow-2xl hover:shadow-green-300/50 transition-all duration-300 hover:-translate-y-2">
            ...
            <div className="relative z-10 flex flex-col items-center text-center">
              <div className="bg-gradient-to-br from-[#059669] to-[#047857] rounded-full size-[64px] flex items-center justify-center mb-[20px] shadow-lg" role="img" aria-label="Global reach icon">
                <span className="text-[32px]" aria-hidden="true">🌍</span>
              </div>
              <div className="text-[56px] font-['Inter:Bold',sans-serif] font-bold bg-gradient-to-br from-[#059669] to-[#15803d] bg-clip-text text-transparent mb-[12px] leading-[1]">26+</div>
              <div className="text-[17px] font-['Inter:Semi_Bold',sans-serif] font-semibold text-[#0f172b] mb-[10px]">Countries</div>
              <p className="text-[15px] font-['Inter:Medium',sans-serif] font-medium text-[#64748b] leading-[22px]">Demonstrating global adoption across diverse communities</p>
            </div>
          </div>
          ...
          <div className="relative bg-gradient-to-br from-[#fed7aa] via-[#fff7ed] to-[#f8fafc] rounded-[20px] border-2 border-[#f97316] p-[40px] shadow-xl shadow-orange-200/40 overflow-hidden group hover:shadow-2xl hover:shadow-orange-300/50 transition-all duration-300 hover:-translate-y-2">
            ...
            <div className="relative z-10 flex flex-col items-center text-center">
              <div className="bg-gradient-to-br from-[#f97316] to-[#ea580c] rounded-full size-[64px] flex items-center justify-center mb-[20px] shadow-lg" role="img" aria-label="Viewers icon">
                <span className="text-[32px]" aria-hidden="true">👁️</span>
              </div>
              <div className="text-[56px] font-['Inter:Bold',sans-serif] font-bold bg-gradient-to-br from-[#f97316] to-[#c2410c] bg-clip-text text-transparent mb-[12px] leading-[1]">24K+</div>
              <div className="text-[17px] font-['Inter:Semi_Bold',sans-serif] font-semibold text-[#0f172b] mb-[10px]">Unique Viewers</div>
              <p className="text-[15px] font-['Inter:Medium',sans-serif] font-medium text-[#64748b] leading-[22px]">Engaging with Story Maps content worldwide</p>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-[20px]">
          <div className="bg-white rounded-[14px] border border-[#e2e8f0] p-[28px] shadow-[0_2px_12px_rgb(0,0,0,0.04)] hover:shadow-[0_4px_20px_rgb(0,0,0,0.08)] transition-shadow">
            <div className="flex flex-col items-center text-center gap-[12px]">
              <div className="w-[56px] h-[56px] rounded-full bg-gradient-to-br from-[#a855f7] to-[#9333ea] flex items-center justify-center shadow-lg" role="img" aria-label="Zero-code workflow icon">
                <span className="text-[28px]" aria-hidden="true">⚡</span>
              </div>
              <div className="text-[32px] font-['Inter:Bold',sans-serif] font-bold text-[#0f172b] leading-[1]">0-code</div>
              <p className="text-[14px] font-['Inter:Regular',sans-serif] text-[#64748b] leading-[20px]">Workflow introduced, eliminating manual configuration files</p>
            </div>
          </div>
          
          <div className="bg-white rounded-[14px] border border-[#e2e8f0] p-[28px] shadow-[0_2px_12px_rgb(0,0,0,0.04)] hover:shadow-[0_4px_20px_rgb(0,0,0,0.08)] transition-shadow">
            <div className="flex flex-col items-center text-center gap-[12px]">
              <div className="w-[56px] h-[56px] rounded-full bg-gradient-to-br from-[#06b6d4] to-[#0891b2] flex items-center justify-center shadow-lg" role="img" aria-label="Global use cases icon">
                <span className="text-[28px]" aria-hidden="true">🌍</span>
              </div>
              <div className="text-[32px] font-['Inter:Bold',sans-serif] font-bold text-[#0f172b] leading-[1]">3+</div>
              <p className="text-[14px] font-['Inter:Regular',sans-serif] text-[#64748b] leading-[20px]">New use cases beyond conservation: civic mapping, flood response, cultural storytelling</p>
            </div>
          </div>
          
          <div className="bg-white rounded-[14px] border border-[#e2e8f0] p-[28px] shadow-[0_2px_12px_rgb(0,0,0,0.04)] hover:shadow-[0_4px_20px_rgb(0,0,0,0.08)] transition-shadow">
            <div className="flex flex-col items-center text-center gap-[12px]">
              <div className="w-[56px] h-[56px] rounded-full bg-gradient-to-br from-[#ec4899] to-[#db2777] flex items-center justify-center shadow-lg" role="img" aria-label="Unified creation flow icon">
                <span className="text-[28px]" aria-hidden="true">✨</span>
              </div>
              <div className="text-[32px] font-['Inter:Bold',sans-serif] font-bold text-[#0f172b] leading-[1]">1</div>
              <p className="text-[14px] font-['Inter:Regular',sans-serif] text-[#64748b] leading-[20px]">Unified creation flow consolidating media upload, geolocation, preview, and publishing</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-gradient-to-br from-[#fef9e7] to-[#fef3c7] rounded-[14px] border-2 border-[#fbbf24] p-[32px]">
          <div className="flex items-start gap-[20px]">
            <div className="bg-[#fbbf24] rounded-[12px] size-[48px] flex items-center justify-center shrink-0" role="img" aria-label="Key insight icon">
              <span className="text-white text-[24px]" aria-hidden="true">💡</span>
            </div>
            <div className="flex-1">
              <h4 className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[28px] text-[#78350f] text-[18px] mb-[12px]">Reflection</h4>
              <p className="font-['Inter:Regular',sans-serif] leading-[26px] text-[#92400e] text-[16px] mb-[16px]">
                This project reinforced the importance of designing for real-world constraints.
              </p>
              <p className="font-['Inter:Regular',sans-serif] leading-[26px] text-[#92400e] text-[16px] mb-[20px]">
                By reducing technical complexity and focusing on familiar interaction patterns, we made storytelling accessible to users who previously depended on developers or external tools.
              </p>
              <div className="bg-white/70 rounded-[10px] p-[20px]">
                <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[28px] text-[#78350f] text-[18px]">
                  The key takeaway for me: Good UX does not add features — it removes barriers.
                </p>
              </div>
            </div>
          </div>
...
export default function CaseStudy2() {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      const sections = ["overview", "problem", "users", "approach", "initial-design", "why-failed", "design-solution", "why-works", "outcome"];
  ...
  return (
    <div className="bg-white w-full min-h-screen pt-[49px]">
      <Header />
      <TopNavigation activeSection={activeSection} setActiveSection={setActiveSection} isScrollingRef={isScrollingRef} />
      <ContentContainer />
      <Footer />
    </div>
  );
