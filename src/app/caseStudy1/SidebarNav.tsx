...
export function SidebarNav() {
  ...
  const scrollToSection = (id: string) => {
    scrollToSectionById(id, {
      offsetSelectors: ["[data-top-chrome='case-study-1']"],
      extraOffset: 12,
    });
  };
  ...
  return (
    <nav
      data-case-study-nav="true"
      className="relative z-10 bg-white/98 backdrop-blur-md border-b border-slate-200 shadow-md"
    >
