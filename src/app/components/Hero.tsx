...
import { ChevronDown, Globe, GraduationCap, Award, Briefcase } from "lucide-react";
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 pt-20">
      ...
      <motion.div 
        ...
        style={{
          background: "radial-gradient(circle at 30% 40%, rgba(99, 102, 241, 0.15) 0%, transparent 50%), radial-gradient(circle at 70% 60%, rgba(14, 165, 233, 0.15) 0%, transparent 50%)"
        }}
        animate={{
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <div>
              ...
              >
                <span className="text-lg text-slate-400">Shivani Srivastava</span>
              </motion.div>
              <motion.h1 
            ...
            >5 years specializing in UX, 8+ years in design—transforming complex enterprise systems into elegant, user-centered solutions across SaaS, fintech, and social impact.</motion.p>
            ...
            >
              <motion.button
                ...
                className="px-8 py-4 bg-white text-slate-900 rounded-xl shadow-lg hover:shadow-xl transition-all"
              ...
              <motion.button
                ...
                className="px-8 py-4 bg-white/10 text-white border border-white/20 rounded-xl backdrop-blur-sm hover:bg-white/15 transition-all"
                style={{ fontWeight: 600 }}
                whileHover={{ scale: 1.02, y: -2 }}
                whileTap={{ scale: 0.98 }}
            ...
            <div className="relative w-full aspect-square">
              ...
              >
                <div className="w-full h-full bg-gradient-to-br from-indigo-500 to-sky-500 p-6 flex flex-col justify-center">
                  ...
                  <div className="text-6xl text-white mb-1" style={{ fontWeight: 700, letterSpacing: "-0.02em" }}>5</div>
              ...
              >
                <div className="w-full h-full bg-gradient-to-br from-slate-700 to-slate-900 p-6 flex flex-col justify-center">
                  ...
                  <div className="text-6xl text-white mb-1" style={{ fontWeight: 700, letterSpacing: "-0.02em" }}>8+</div>
              ...
              >
                <div className="w-full h-full bg-white p-6 flex flex-col justify-center items-center text-center">
                  ...
                  <div className="text-base text-slate-800 mb-1" style={{ fontWeight: 600 }}>
                    NUS (MAUD)
                  </div>
                  <div className="text-base text-slate-800" style={{ fontWeight: 600 }}>
                    UCLA (UX)
                  </div>
                  <div className="text-sm text-slate-500 mt-2">Graduate Education</div>
                </div>
              </motion.div>
              ...
              >
                <div className="w-full h-full bg-gradient-to-br from-sky-500 to-indigo-500 p-6 flex flex-col justify-center items-center text-center">
                  ...
                  <div className="text-base text-white mb-1" style={{ fontWeight: 600 }}>
                    Global Experience
                  </div>
                  <div className="text-sm text-white/80"></div>
                  <div className="text-sm text-white/80">India · USA</div>
                </div>
              </motion.div>
            </div>
          </motion.div>
