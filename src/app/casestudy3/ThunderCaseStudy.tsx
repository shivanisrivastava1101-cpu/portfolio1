    ...
    >
      ...
      <div className="lg:hidden relative">
        <div className="overflow-x-auto overflow-y-hidden scrollbar-hide scroll-smooth">
          <div
            className="flex items-center gap-4 px-[24px] py-[0px]"
    ...
    <div className="pt-8 pb-16 relative overflow-hidden">
      ...
      <div className="w-full px-6 relative z-10">
        <div className="flex flex-col gap-6">
          ...
          >
            Enhancing iOS App Design experience for Thunder Rewards and
            Thunderstand
          </motion.h1>
          ...
          >
            Maintaining user engagement while improving the UX of our
        ...
        >
          ...
          >
            ...
            <p className="text-white font-medium">
              Issam Khalloufi, Leina Zoutine, Myself
            </p>
          </motion.div>
        </motion.div>
    ...
    >
      <div className="">
        ...
        >
          ...
          >
            At Zeta Learning, a California-based startup, I worked as the sole
            UX Designer and Researcher across two connected iOS products:
            Thunder Rewards and Thunderstand.
          </motion.p>
          ...
          >
            Thunder Rewards used incentive-based engagement, while Thunderstand
            was a new personalised learning app preparing for launch. My
            responsibility was to maintain engagement in Thunder Rewards while
            improving usability in Thunderstand — under tight time and resource
            constraints.
          </motion.p>
          ...
          >
            ...
            >
              ...
              <div className="flex items-start gap-4 mb-4">
                ...
                <div className="flex-1">
                  <h3 className="text-[#ff6b6b] text-2xl font-bold mb-2">
                    🎁 Thunder Rewards
                  </h3>
              ...
              <p className="text-[#cbd5e1] leading-relaxed text-base pl-1">
                Shipping physical rewards had become resource-intensive. With
                Thunderstand's launch approaching, we needed to delay shipments
                by one month without damaging user trust or engagement.
              </p>
            </motion.div>
            ...
            >
              ...
              <div className="flex items-start gap-4 mb-4">
                ...
                <div className="flex-1">
                  <h3 className="text-[#6BB8FF] text-2xl font-bold mb-2">
                    💡 Thunderstand
                  </h3>
              ...
              <p className="text-[#cbd5e1] leading-relaxed text-base pl-1">
                Usability testing revealed friction in onboarding and task
                completion. The pre-interaction stage felt long and cognitively
                heavy. With launch approaching, we had to prioritise
                improvements that were achievable within three weeks.
              </p>
            </motion.div>
          </motion.div>
      ...
      <div className="flex flex-col gap-12">
        ...
        >
          ...
          <p className="text-[#cbd5e1] leading-relaxed relative z-10">
            I conducted Instagram polls, Google surveys, and in-depth interviews
            with <span className="text-[#7ED957] font-bold">10 students</span>{" "}
            across the US and UK to understand their perspectives on reward
            delays and the Thunderstand beta experience.
          </p>
        </motion.div>
        ...
        >
          ...
          >
            <div className="flex items-start gap-4">
              ...
              <div>
                <h4 className="text-[#6BB8FF] font-bold mb-2 text-lg">
                  ☀️ Summer Activity Drop
                </h4>
                <p className="text-[#cbd5e1] text-sm leading-relaxed">
                  App usage decreased significantly during school breaks,
                  revealing seasonal engagement patterns.
                </p>
              </div>
            </div>
          </motion.div>
          ...
          >
            <div className="flex items-start gap-4">
              ...
              <div>
                <h4 className="text-[#6BB8FF] font-bold mb-2 text-lg">
                  💬 Proactive Communication Works
                </h4>
                <p className="text-[#cbd5e1] text-sm leading-relaxed">
                  Premium users responded positively to advance notice about
                  shipping delays.
                </p>
              </div>
            </div>
          ...
          >
            <div className="flex items-start gap-4">
              ...
              <div>
                <h4 className="text-[#6BB8FF] font-bold mb-2 text-lg">
                  🎁 Bonus Rewards Drive Engagement
                </h4>
                <p className="text-[#cbd5e1] text-sm leading-relaxed">
                  Small incentives significantly increased motivation during the
                  delay period.
                </p>
              </div>
            </div>
          ...
          >
            <div className="flex items-start gap-4">
              ...
              <div>
                <h4 className="text-[#8b5cf6] font-bold mb-2 text-lg">
                  📋 Onboarding Too Long
                </h4>
                <p className="text-[#cbd5e1] text-sm leading-relaxed">
                  11-screen onboarding overwhelmed users, causing abandonment
                  before completion.
                </p>
              </div>
            </div>
          ...
          >
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-[#cbd5e1] text-sm leading-relaxed">
                  Users needed immediate clarity on how the app helps them
                  study.
                </p>
              </div>
            </div>
          ...
          >
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-[#cbd5e1] text-sm leading-relaxed">
                  Small UI refinements could improve task completion within the
                  3-week timeline.
                </p>
              </div>
            </div>
        ...
        >
          ...
          <p className="text-[#cbd5e1] text-sm leading-relaxed relative z-10">
            Limited resources and a tight timeline meant we needed to delay
            reward shipping without compromising engagement, while quickly
            iterating Thunderstand for launch.
          </p>
        </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            >
              ...
              <p className="text-[#cbd5e1] text-sm leading-relaxed italic">
                "How might we delay reward delivery and still maintain premium
                member engagement?"
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-[#cbd5e1] text-sm leading-relaxed italic">
                "How might we identify achievable UI improvements before launch
      ...
      <div className="max-w-[1056px] mx-auto px-6">
        <div className="flex flex-col gap-8">
          ...
          <p className="text-[#cbd5e1] leading-relaxed">
            In order to ensure our team remained focused on creating
            user-centered products, I took the initiative to create user stories
            that helped us deeply understand the value of what we were building.
            By sharing these user stories with the team, we were able to keep
            the user at the forefront of our decision-making process.
          </p>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              <div className="group relative bg-gradient-to-br from-[#1a2847] to-[#2B1E5A] rounded-2xl shadow-2xl hover:shadow-[#fbbf24]/20 hover:shadow-2xl transition-all duration-300 hover:-translate-y-1 overflow-hidden border border-white/10">
                ...
                <div className="relative p-8">
                  ...
                  <p className="text-[#6BB8FF] italic leading-relaxed mb-6 text-lg font-medium">
                    "I want to navigate to the new app that is supposed to be my
                    bonus reward real quick, so I don't have to waste time
                    searching for it on the app store."
                  </p>
                  <div className="pt-6 border-t-2 border-[#fbbf24]/30">
                    ...
                    <p className="text-[#cbd5e1] leading-relaxed">
                      Implement easy-to-find breadcrumbs within our app that
                      lead directly to the newly launched app, allowing users to
                      quickly access their bonus reward.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="group relative bg-gradient-to-br from-[#1a2847] to-[#2B1E5A] rounded-2xl shadow-2xl hover:shadow-[#06b6d4]/20 hover:shadow-2xl transition-all duration-300 hover:-translate-y-1 overflow-hidden border border-white/10">
                ...
                <div className="relative p-8">
                  ...
                  <p className="text-[#6BB8FF] italic leading-relaxed mb-6 text-lg font-medium">
                    "I just want to know ahead of time if there are any reward
                    delays, so I don't feel like I'm getting blindsided."
                  </p>
                  <div className="pt-6 border-t-2 border-[#06b6d4]/30">
                    <div className="flex items-start gap-2 mb-2">
                      <span className="text-[#06b6d4] mt-1">💡</span>
                      <span className="text-[#06b6d4] font-semibold text-sm">
                        SOLUTION
                      </span>
                    </div>
                    <p className="text-[#cbd5e1] leading-relaxed">
                      Proactively notify users of potential reward shipping
                      delays and offer a bonus reward as appreciation for their
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              <div className="group relative bg-gradient-to-br from-[#1a2847] to-[#2B1E5A] rounded-2xl shadow-2xl hover:shadow-[#a78bfa]/20 hover:shadow-2xl transition-all duration-300 hover:-translate-y-1 overflow-hidden border border-white/10">
                ...
                <div className="relative p-8">
                  ...
                  <p className="text-[#6BB8FF] italic leading-relaxed mb-6 text-lg font-medium">
                    "I want to quickly learn how the app can help me study
                    better so that I don't waste too much time figuring out what
                    it does."
                  </p>
                  <div className="pt-6 border-t-2 border-[#a78bfa]/30">
                    <div className="flex items-start gap-2 mb-2">
                      <span className="text-[#c084fc] mt-1">💡</span>
                      <span className="text-[#c084fc] font-semibold text-sm">
                        SOLUTION
                      </span>
                    </div>
                    <p className="text-[#cbd5e1] leading-relaxed">
                      Condense the 11-screen onboarding into 3-4 screens that
                      effectively communicate the app's value proposition,
                      reducing cognitive load and improving retention.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="group relative bg-gradient-to-br from-[#1a2847] to-[#2B1E5A] rounded-2xl shadow-2xl hover:shadow-[#7ED957]/20 hover:shadow-2xl transition-all duration-300 hover:-translate-y-1 overflow-hidden border border-white/10">
                ...
                <div className="relative p-8">
                  ...
                  <p className="text-[#6BB8FF] italic leading-relaxed mb-6 text-lg font-medium">
                    "I want to be able to easily complete tasks and understand
                    what the app is doing for me as I go through the flow so
                    that I can feel confident and in control while using the
                    app."
                  </p>
                  <div className="pt-6 border-t-2 border-[#7ED957]/30">
                    <div className="flex items-start gap-2 mb-2">
                      <span className="text-[#7ED957] mt-1">💡</span>
                      <span className="text-[#7ED957] font-semibold text-sm">
                        SOLUTION
                      </span>
                    </div>
                    <p className="text-[#cbd5e1] leading-relaxed">
                      Optimize value propositions and enhance task completion by
                      identifying minor changes that improve user effectiveness
                      and confidence.
                    </p>
                  </div>
                </div>
  ...
  return (
    ...
    >
      <div className="flex flex-col gap-8">
        ...
        <p className="text-[#cbd5e1] leading-relaxed">
          I used the user stories as a basis for creating both low-fidelity and
          high-fidelity wireframes. Throughout the design process, I conducted
          frequent testing sessions with all stakeholders. The objective was to
          find the optimal balance between user needs and project constraints in
          order to achieve the best possible product outcomes.
        </p>
        ...
        <div className="mt-12">
          ...
          <h4 className="text-[#6BB8FF] text-xl font-semibold mb-6">
            Improving Engagement through Compelling Content Strategy
          </h4>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
            <div className="rounded-2xl p-8 overflow-hidden bg-white shadow-2xl border border-white/10">
              ...
              />
              <p className="text-[#64748b] text-center text-sm mt-4">
                Iteration 1: Pop-up on the Home Screen
              </p>
            </div>
            ...
            <div className="bg-gradient-to-br from-[#6BB8FF]/10 to-[#3b82f6]/10 border border-[#6BB8FF]/30 rounded-xl p-6 flex items-center shadow-lg">
              <p className="text-[#cbd5e1] leading-relaxed">
                Although the first iteration provided the necessary information
                to users, it failed to engage them. The goal was to create
                compelling content that serves as a breadcrumb trail, guiding
                users to discover and explore the new app. To achieve this
                objective, we need to implement an effective content strategy
                that not only informs but also motivates users to take advantage
                of their "bonus reward."
              </p>
            </div>
          </div>
          ...
          <div className="mt-12 bg-gradient-to-br from-[#7ED957]/10 to-[#10b981]/10 border border-[#7ED957]/30 rounded-2xl p-8 shadow-2xl">
            <h4 className="text-[#7ED957] text-2xl font-semibold mb-4">
              Final Design Solution
            </h4>
            <p className="text-[#cbd5e1] leading-relaxed mb-6">
              Creating a transition experience from normal mode to summer break
              mode by hinting at what's coming next.
            </p>
              ...
              <div className="bg-white rounded-xl p-6 shadow-2xl">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                  <div>
                    ...
                    />
                    <p className="text-[#64748b] text-center text-sm mt-2">
                      Home Screen (Before)
                    </p>
                  </div>
                  <div>
                    ...
                    />
                    <p className="text-[#64748b] text-center text-sm mt-2">
                      Pop-up on Home Screen
                    </p>
                    <p className="text-[#64748b] text-center text-sm">
                      Released 15 days before Summer mode
                    </p>
                  </div>
                  <div>
                    <img
                    ...
                    />
                    <p className="text-[#64748b] text-center text-sm mt-2">
                      Summer Break Mode Pop-up on Home Screen
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white rounded-xl p-6 shadow-2xl">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  <div>
                    ...
                    />
                    <p className="text-[#64748b] text-center text-sm mt-2">
                      Summer Break Mode Announcement Screen
                    </p>
                  </div>
                  <div>
                    <img
                    ...
                    />
                    <p className="text-[#64748b] text-center text-sm mt-2">
                      The 'download app' button takes the user to the
                      'Thunderstand' product on the app store.
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div className="mt-16">
          ...
          <p className="text-[#cbd5e1] leading-relaxed mb-8">
            To achieve this, we can aim to provide users with quick insights
            into the app benefits within the first 3-4 screens, while also
            incorporating a user progress indicator to guide them through the
            flow and build their confidence in the product. By implementing
            these strategies, we can create a positive user experience that
            encourages continued engagement with our app.
          </p>
            ...
            <div className="rounded-xl p-6">
              ...
              <div className="bg-white rounded-lg p-4 shadow-2xl">
                <img
                  ...
                  className="w-full h-auto rounded-lg"
                />
                <p className="text-[#64748b] text-center text-sm mt-3">
            ...
            <div className="rounded-xl p-6">
              ...
              <div className="bg-white rounded-lg p-4 shadow-2xl">
                <img
                  ...
                  className="w-full h-auto rounded-lg"
                />
                <p className="text-[#7ED957] font-medium text-center text-sm mt-3">
                  3-4 concise screens with progress indicator
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="mt-8 bg-gradient-to-r from-[#fbbf24]/20 to-[#f59e0b]/20 border border-[#fbbf24]/30 rounded-xl p-6 shadow-lg">
            <h4 className="text-[#fbbf24] text-lg font-semibold mb-4">
              Learn and Pivot: Categorizing and grouping the assessment
              questions into buckets
            </h4>
            <p className="text-[#cbd5e1] leading-relaxed mb-4">
              Our current questionnaire comprises 23 questions, which may
              overwhelm users and make the task seem insurmountable. To address
              this, we can break down the big task into smaller ones to make the
              work more manageable and less intimidating. This approach will
              help users feel in control at every step and achieve "quick wins"
              as they progress through each category.
            </p>
            ...
            <div className="mt-6 bg-white rounded-xl p-6 shadow-2xl">
              ...
              <p className="text-[#64748b] mt-6 text-center">
                The 23 questions were organized into five buckets based on their
                content.
              </p>
            </div>

            <p className="text-[#94a3b8] text-sm italic mt-4">
              Note: This section of the design was delayed for development due
        ...
        <div className="flex flex-col gap-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
            {metrics.map((metric, idx) => (
              ...
              >
                ...
                <p className="text-white text-lg font-bold mb-3 uppercase tracking-wide">
                  {metric.label}
                </p>
                <p className="text-[#cbd5e1] leading-relaxed">
                  {metric.description}
                  {metric.subtext && (
                    <span className="block text-sm mt-2 text-[#7ED957] font-semibold">
                      {metric.subtext}
                    </span>
                  )}
                </p>
          ...
          >
            <p className="text-[#6BB8FF] text-sm italic font-medium flex items-center gap-2">
              ℹ️ All metrics reflect early-stage usability testing and
              short-term product signals.
            </p>
          </motion.div>
        </div>
      </div>
        ...
        <div className="flex flex-col gap-8">
          ...
          >
            ...
            <p className="text-[#cbd5e1] text-lg leading-relaxed mb-4">
              This project reinforced the importance of prioritisation under
              constraints.
            </p>

            <p className="text-[#cbd5e1] leading-relaxed relative z-10">
              Instead of attempting large-scale redesigns, we focused on small,
              high-impact changes that were realistic within three weeks.
            </p>
          </motion.div>
          ...
          <div className="mt-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="group bg-gradient-to-br from-[#1a2847] to-[#2B1E5A] border-l-4 border-[#6BB8FF] rounded-xl p-8 shadow-2xl hover:shadow-[#6BB8FF]/20 hover:shadow-2xl transition-all duration-300 hover:-translate-y-1">
                ...
                <p className="text-[#cbd5e1] leading-relaxed">
                  Transparent communication maintains trust during operational
                  changes
                </p>
              </div>
              ...
              <div className="group bg-gradient-to-br from-[#1a2847] to-[#2B1E5A] border-l-4 border-[#a78bfa] rounded-xl p-8 shadow-2xl hover:shadow-[#a78bfa]/20 hover:shadow-2xl transition-all duration-300 hover:-translate-y-1">
                ...
                <p className="text-[#cbd5e1] leading-relaxed">
                  Reducing cognitive load can significantly improve perceived
                  usability
                </p>
              </div>
              ...
              <div className="group bg-gradient-to-br from-[#1a2847] to-[#2B1E5A] border-l-4 border-[#7ED957] rounded-xl p-8 shadow-2xl hover:shadow-[#7ED957]/20 hover:shadow-2xl transition-all duration-300 hover:-translate-y-1">
                ...
                <p className="text-[#cbd5e1] leading-relaxed">
                  Incremental UX improvements can meaningfully influence
                  engagement
                </p>
              </div>
